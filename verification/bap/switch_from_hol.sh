../../utils/scripts/baputils.py --preprocess src/from_hol/switch.il ../out/from_hol/switch.il
/opt/trunk/utils/topredicate -validity -il ../out/from_hol/switch.il -post goal -stp-out ../out/from_hol/switch.stp
stp ../out/from_hol/switch.stp
