../../utils/scripts/baputils.py --preprocess src/from_hol/si_1.il ../out/from_hol/si_1.il
/opt/trunk/utils/topredicate -validity -il ../out/from_hol/si_1.il -post goal -stp-out ../out/from_hol/si_1.stp
stp ../out/from_hol/si_1.stp
